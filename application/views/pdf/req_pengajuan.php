...
<body style="margin:50px;">
  <table width="450" border="0" cellpadding="2" cellspacing="0" align="center">
    ...
    <tr colspan="4">
      <td>Perihal</td>
      <td>:</td>
      <td>Permohonan Izin Peminjaman Barang</td>
      <td></td>
    </tr>
  </table>
    ...
    <tr>
      <td>
        <p style="text-align:justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          Sehubungan dengan adanya kebutuhan dalam kegiatan <?php echo $a->deskripsi; ?> PT. Pertamina Drilling Services Indonesia,
          melalui surat ini kami memohon bantuan kepada fungsi ICT PT. Pertamina Drilling Services Indonesia
          untuk memberikan izin peminjaman barang pada tanggal <?php echo $tanggal; ?>.
          Berikut ini rincian barang tersebut :
        </p>
      </td>
    </tr>
    <?php } ?>
