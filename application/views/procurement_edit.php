    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <input type="text" class="form-control" id="ticket" name="ticket" maxlength="15" value="<?= $d->ticket?>">
        </div>
            ...
            <input type="text" class="form-control" id="serialnumber" name="serialnumber" value="<?= $d->serialnumber?>">
            </div>

            <!-- value price -->
            <div class="form-group">
            <label for="valueprice">Value Price</label>
            <input type="text" class="form-control" id="valueprice" name="valueprice" value="<?= $d->valueprice?>">
            </div>

            <!-- quantity -->
            <div class="form-group">
            <label for="quantity">Quantity</label>
            <input type="number" class="form-control" id="quantity" name="quantity" value="<?= $d->quantity?>">
            </div>

            <!-- description -->
            <div class="form-group">
            <label for="description">Description</label>
            <textarea class="form-control" id="description" rows="3" name="description"><?= $d->description?></textarea>
            </div>
